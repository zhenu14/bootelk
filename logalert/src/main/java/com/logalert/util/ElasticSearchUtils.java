...
//        LOGGER.info("\n{}", searchRequestBuilder);
    ...
    public static EsHelper RangeSearch(String rangeField,String start,String end,String displayField){
        ...
        AggregationBuilder aggregation = AggregationBuilders.terms("agg").field("appname.keyword");
...
//        LOGGER.info("共查询到[{}]条数据,处理数据条数[{}]", totalHits, length);
        ...
        esHelper.setAppnames(appnames);
        esHelper.setSourceList(sourceList);
        return esHelper;
//
//        return sourceList;
    }

    public static Map<String,Long> getAppnames(String rangeField,String start,String end){
        //时间范围的设定
        RangeQueryBuilder rangequerybuilder = QueryBuilders
                .rangeQuery(rangeField)
                .gte(start).lt(end);
...
//        sourceBuilder.query(rangequerybuilder);
        ...
        if(totalHits == 0 || length == 0){
            LOGGER.info("getAppnames ：null");
            return null;
        }
    ...
    public static List<Map<String, Object>> getRangeByAppname(String rangeField,String start,String end,String displayField,String appname){
...
//        sourceBuilder.query(rangequerybuilder);
        ...
        if(totalHits == 0 || length == 0){
            LOGGER.info("getRangeByAppname ：null");
            return null;
        }
